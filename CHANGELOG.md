...
* 修复 init 后执行 yarn 的时候目录错误 ([806b31a](https://github.com/aotuzuche/autos/commit/806b31a))


### Performance Improvements

* 增加 prettier 和 eslint 流程 ([c86e726](https://github.com/aotuzuche/autos/commit/c86e726))
